...
<div class="mbl-view tab-view">
    <nav class="navbar bg-body-tertiary fixed-top">
        <div class="container-fluid d-flex px-2">
            <a class="navbar-brand d-flex align-items-center" href="{{url('/')}}"><img src="{{url('assets/images/logo/53e0228d2974f464887e16225903a69bdf5b51c0.png')}}" alt="Jai Agro Machinery" class="navbar-logo ps-2"/><h5 class="agro_txt_clr mb-0">Jai Agro Machinery</h5></a>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                <div class="offcanvas-header">
                    <h5 class="offcanvas-title" id="offcanvasNavbarLabel"><a href="{{url('/')}}" class="d-flex text-decoration-none align-items-center"><img src="{{url('assets/images/logo/53e0228d2974f464887e16225903a69bdf5b51c0.png')}}" alt="Jai Agro Machinery" class="navbar-logo ps-2"/><h5 class="agro_txt_clr mb-0">Jai Agro Machinery</h5></a>
