                        ...
                        <div class="col-12 col-xs-12 col-sm-4 col-md-4 col-lg-3 col-xl-3 col-xxl-3 py-2">
                            <div class="card justify-content-between border-0 p-2 h-100" data-aos="fade-up" data-aos-duration="1000">
                                ...
                                <div>
                                    ...
                                    <a href="{!! url('/products/' . strtolower(str_replace(' ', '-', strip_tags($prdt->title)))) !!}" class="agro_bg_clr text-white text-decoration-none py-1 px-2 rounded-1 d-flex justify-content-between align-items-center"><div>View More Details </div><svg width="7" height="14" viewBox="0 0 7 14" fill="none" xmlns="http://www.w3.org/2000/svg">
